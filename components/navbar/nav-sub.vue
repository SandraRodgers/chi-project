<template>
    <div class="nav-sub z-20">
        <div class="lg:flex md:flex flex-row-reverse content-around bg-transparent right-0 hidden">
            ...
            class="absolute z-10 bg-white top-24 pt-6 right-96 border border-opacity-25 border-davysGrey transition-opacity duration-800 ease-in rounded-sm mr-24 md:mr-0 lg:mr-24">
