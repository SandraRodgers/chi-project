                ...
                <div class="flex flex-col items-center w-full">
                    <div class="flex w-full">
                        <div class="flex flex-col items-center px-4 mx-4 w-3/4">
                            ...
                            <h3 class="text-black text-2xl font-semibold my-4">{{ourImpact.impactOneHeader}}</h3>
                            <h4
                            :class="{'opacity-0': !factIsVisibleOne, 'flex flex-col opacity-100': factIsVisibleOne}" class="text-black font-light my-4 text-med transition-opacity duration-1000 ease-in">{{ourImpact.impactOneFact}}</h4>
                        </div>
                        <div class="flex flex-col items-center px-4 mx-4 w-3/4">
                            ...
                            <h3 class="text-black text-2xl font-semibold my-4">{{ourImpact.impactTwoHeader}}</h3>
                            <h4
                            :class="{'opacity-0': !factIsVisibleTwo, 'flex flex-col opacity-100': factIsVisibleTwo}" class="text-black font-light my-4 text-med transition-opacity duration-1000 ease-in">{{ourImpact.impactTwoFact}}</h4>
                        </div>
                    </div>
                    <div class="flex w-full">
                        <div class="flex flex-col items-center px-4 mx-4 w-3/4">
                            ...
                            <h3 class="text-black text-2xl font-semibold my-4">{{ourImpact.impactThreeHeader}}</h3>
                            <h4
                            :class="{'opacity-0': !factIsVisibleThree, 'flex flex-col opacity-100': factIsVisibleThree}" class="text-black font-light my-4 text-med transition-opacity duration-1000 ease-in">{{ourImpact.impactThreeFact}}</h4>
                        </div>
                        <div class="flex flex-col items-center px-4 mx-4 w-3/4">
                            ...
                            <h3 class="text-black text-2xl font-semibold my-4">{{ourImpact.impactFourHeader}}</h3>
                            <h4
                            :class="{'opacity-0': !factIsVisibleFour, 'flex flex-col opacity-100': factIsVisibleFour}" class="text-black font-light my-4 text-med transition-opacity duration-1000 ease-in">{{ourImpact.impactFourFact}}</h4>
                        </div>
                    </div>
                </div>
            </div>
