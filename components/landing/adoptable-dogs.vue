    ...
    <div class="w-full my-4 sm:my-4 lg:my-8">
        ...
        <div class="flex lg:flex-row mt-4 lg:mt-6 sm:mt-4 h-2/3 lg:h-80 sm:h-2/3 relative">
            <div class="overflow-hidden mx-2 shadow-lg">
                <h2 class="js-show-on-scroll z-20 ml-4 absolute top-0 mt-2 font-semibold text-xs md:text-3xl lg:text-4xl sm:text-xs pt-4 sm:pt-4 lg:pt-2 md:pt-2 mt-2 text-white">
                    <nuxt-link :to="{ path: '/adopt/southeast'}">Southeast</nuxt-link>
                </h2>
                <img 
                    :src="imageUrlFor(adoptableDogs.regionOneImage)"
                    class="relative object-cover h-2/3 lg:h-80 sm:h-2/3 mr-2 transition transform hover:scale-125 duration-500 rounded-sm shadow-lg"
                />
            ...
            class="js-show-on-scroll z-20 ml-4 lg:ml-24 sm:ml-4 absolute top-0 mt-2 font-semibold text-xs md:text-3xl lg:text-4xl sm:text-xs pt-4 sm:pt-4 lg:pt-2 md:pt-2 mt-2 text-white"><nuxt-link :to="{ path: '/adopt/midwest'}">Midwest</nuxt-link></h2>
                ...
                <img 
                    ...
                    class="relative object-cover h-2/3 lg:h-80 sm:h-2/3 transition transform hover:scale-125 duration-500 rounded-sm shadow-lg"
                />
            ...
            <img 
                ...
                class="object-cover opacity-2 h-2/3 lg:h-80 sm:h-2/3 transition transform hover:scale-125 duration-500 rounded-sm shadow-lg"
            />
