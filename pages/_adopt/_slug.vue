        ...
        <div class="flex items-center justify-center flex-col bg-white w-11/12">
          ...
          <div class="px-14">
            <div class="flex items-start  py-4 md:py-6 lg:py-8 bg-white text-xs md:text-sm lg:text-base">
              ...
              <div class="w-5/6">
              <div class="flex py-1">
                <div class="w-28 font-medium">Name:</div>
                <div class="ml-10">{{chihuahua.chihuahua}}</div>
              </div>
              <div class="flex py-1">
                <div class="w-28 font-medium">Gender:</div>
                <div class="ml-10">{{chihuahua.gender}}</div>
              </div>
              <div class="flex py-1">
                <div class="w-28 font-medium">Age:</div>
                <div class="ml-10">{{chihuahua.age}}</div>
              </div>
              <div class="flex py-1">
                <div class="w-28 font-medium">Weight:</div>
                <div class="ml-10">{{chihuahua.weight}}</div>
              </div>
              <div class="flex py-1">
                <div class="w-28 font-medium">Dogs/Cats:</div>
                <div class="ml-10">{{chihuahua.dogsCats}}</div>
              </div>
              <div class="flex py-1">
                <div class="w-28 font-medium">Children:</div>
                <div class="ml-10">{{chihuahua.children}}</div>
              </div>
            </div>
            </div>
              ...
              <div class="flex flex-col ml-2 items-end w-2/6">
                ...
                <div v-if="chihuahua.imageTwo" class="px-2 py-1">
                  <img class="h-80" :src="imageUrlFor(chihuahua.imageTwo)"/>
                </div>
                <div v-if="chihuahua.imageThree" class="px-2 py-1">
                  <img class="h-80" :src="imageUrlFor(chihuahua.imageThree)"/>
                </div>
                <div v-if="chihuahua.imageFour" class="px-2 py-1">
                  <img class="h-80" :src="imageUrlFor(chihuahua.imageFour)"/>
                </div>
                <div v-if="chihuahua.imageFive" class="px-2 py-1">
                  <img class="h-80" :src="imageUrlFor(chihuahua.imageFive)"/>
                </div>
                <div v-if="chihuahua.imageSix" class="px-2 py-1">
                  <img class="h-80" :src="imageUrlFor(chihuahua.imageSix)"/>
                </div>
