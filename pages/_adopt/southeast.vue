<template>
        ...
        <div class="flex items-center justify-center flex-col bg-white w-11/12">
            ...
            <p><strong class="mr-2">Contact: </strong><a href="mailto:carolinascoordinator@chihuahua-rescue.com" class="font-medium text-starCommandBlue hover:opacity-80">carolinascoordinator@chihuahua-rescue.com</a> if you have any questions.</p>
