<template>
    <div class="bg-whitesmoke pt-10 lg:pt-10 pb-6 md:pb-8 lg:pb-16 flex flex-col items-center justify-center w-full">
        ...
        <div class="flex items-center justify-center flex-col bg-white w-11/12">
            ...
            <p class="flex flex-col items-center text-center w-11/12 md:w-11/12 lg:w-11/12 px-2 py-2 sm:py-2 md:py-6 lg:py-8 bg-white text-xs md:text-sm lg:text-base">All dogs listed here are adoptable in the following Midwestern states (OH / KY/ IL / MI / WI/ MN). We do transport! They are spread out throughout the Midwest in foster homes.</p>
            <p class="flex flex-col items-center text-center w-11/12 md:w-11/12 lg:w-11/12 px-2 py-4 md:py-6 lg:py-8 bg-white text-xs md:text-sm lg:text-base"><strong class="mr-2">Contact: </strong><a href="mailto:MidwestCoordinator@chihuahua-rescue.com" class="font-medium text-starCommandBlue hover:opacity-80">MidwestCoordinator@chihuahua-rescue.com</a> if you have any questions.</p>
        
            <div class="bg-white items-center md:justify-center lg:justify-center flex flex-col md:flex-row lg:flex-row xl:flex-row w-10/12 md:w-10/12 lg:w-11/12">
